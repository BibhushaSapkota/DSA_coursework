...
class mainweek4{
        ...
        public static void main(String[] args) {
                ...
                ArrayList<ArrayList<int[]>> allCollinearPoints = obj.findAllCollinearPoints(num);
                ArrayList<int[]> maxPointsInSameLine = obj.findMaxPointsInALine(allCollinearPoints);
                double length = obj.findLengthOfLine(maxPointsInSameLine);
